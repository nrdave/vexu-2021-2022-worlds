...
class Claw {
     ...
     * @param revs A list of booleans indicating which motors are reversed (close is assumed to be the positive direction)
     */ 
     ...
     *-------------------*/
        ...
        /**
         * Function: openTo
         * Rotates the claw open by a given degree amount, or by a default rotation given using setDigitalRotation.
         * 
         * @param degrees The amount of degrees to rotate the claw open by
         *                If no value is provided, use digitalRotation
         * @param hold indicates whether the motors should hold the claw's position, or let it spin
         */ 
            void openTo(double degrees = digitalRotation, bool hold);

        /**
         * Function: closeTo
         * Rotates the claw closed by a given degree amount, or by a default rotation given using setDigitalRotation.
         * 
